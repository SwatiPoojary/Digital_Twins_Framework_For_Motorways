...
from constants import CAMERA_LOOKUP, DECODING
...
def run():
    ...
    for msg in consumer:
        ...
        # if int(msg.partition) == 0 or int(msg.partition) == 1 or int(msg.partition) == 2:
        addVehicleToSimulation(motorway_cameras_data, net, vehicle_dict, i, route_list, int(msg.partition))
